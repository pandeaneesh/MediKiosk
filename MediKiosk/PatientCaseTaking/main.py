...
if __name__ == "__main__":
    ...
    # Ensure window is un-minimized and brought to foreground
    ...
    # Clear stays-on-top after 2.5 seconds so user can freely interact with other windows
    def release_stays_on_top():
        try:
            window.setWindowFlags(window.windowFlags() & ~Qt.WindowStaysOnTopHint)
            window.show()
            window.raise_()
    ...
    QTimer.singleShot(2500, release_stays_on_top)
