      ...
      <main className="w-full max-w-6xl mx-auto my-auto py-6 z-10 space-y-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 pt-2">
          ...
          <div
            ...
            className="group relative bg-white/95 backdrop-blur-md rounded-3xl border-4 border-blue-300 hover:border-blue-600 p-6 sm:p-7 shadow-xl shadow-blue-500/15 hover:shadow-2xl hover:shadow-blue-600/25 transition-all duration-300 cursor-pointer flex flex-col justify-between active:scale-[0.99] overflow-hidden ring-2 ring-blue-500/10"
          >
            ...
            <div className="relative z-10 space-y-4">
              ...
              <div>
                <div className="inline-block px-2.5 py-0.5 rounded-md bg-blue-100 text-blue-800 text-[11px] font-black uppercase tracking-wide mb-1">
                  🔵 नीला बटन (Blue)
                </div>
                ...
                <p className="text-xs text-slate-600 mt-2 font-medium leading-relaxed">
                  डॉक्टर को दिखाने, नई पर्ची या ओपीडी टोकन लेने और दशविध परीक्षा के लिए इस <strong>नीले बटन</strong> को दबाएं।
                </p>
              </div>
              ...
              <div className="space-y-2 pt-2 border-t border-slate-100 text-xs font-semibold text-slate-700">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-emerald-900 font-extrabold">आयुर्वेदिक १०-प्रश्न दशविध परीक्षा</span>
                </div>
              </div>
            </div>
    ...
    <div className="w-full min-h-screen relative font-sans">
      ...
      {portalMode === 'landing' && (
        <RoleSelectionLanding 
          onSelectRole={(role) => setPortalMode(role)} 
        />
      )}
      ...
      {portalMode === 'doctor' && (
        authenticatedDoctor ? (
          <PhysicianDashboard 
            ...
            onLogout={() => setAuthenticatedDoctor(null)}
            onReturnToMenu={handleReturnToMenu}
          />
        ) : (
          <DoctorLogin 
            onLoginSuccess={(doc) => setAuthenticatedDoctor(doc)}
            onReturnToMenu={handleReturnToMenu}
          />
        )
      )}
      ...
      {portalMode === 'admin' && (
        authenticatedAdmin ? (
          <AdminDashboard
            ...
            onLogout={() => setAuthenticatedAdmin(null)}
            onReturnToMenu={handleReturnToMenu}
          />
        ) : (
          <AdminLogin
            onLoginSuccess={(admin) => setAuthenticatedAdmin(admin)}
            onReturnToMenu={handleReturnToMenu}
          />
        )
      )}
